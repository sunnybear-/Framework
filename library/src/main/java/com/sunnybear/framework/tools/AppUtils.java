...
public final class AppUtils {
    ...
    public static boolean isServiceRunning(Context context, Class<? extends Service> service) {
        ...
        for (ActivityManager.RunningServiceInfo si : servicesList) {
            if (service.getName().equals(si.service.getClassName()))
                isRunning = true;
        }
        return isRunning;
    }
    ...
    public static boolean isApplicationInForeground(Context context) {
        ...
        List<ActivityManager.RunningAppProcessInfo> taskList = am.getRunningAppProcesses();
        if (taskList == null) return false;
        for (ActivityManager.RunningAppProcessInfo appProcess : taskList) {
    ...
    public static boolean isDalvik() {
        return TextUtils.equals(getCurrentRuntimeValue(), "Dalvik");
    }
    ...
    public static boolean isART() {
        return TextUtils.equals(getCurrentRuntimeValue(), "ART")
                || TextUtils.equals(getCurrentRuntimeValue(), "ART debug build");
    }
