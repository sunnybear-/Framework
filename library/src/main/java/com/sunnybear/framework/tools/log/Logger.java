...
public final class Logger {
    ...
    private static void printStackTrace() {
        ...
        for (String trace : traceString) {
            if (trace.contains("at com.sunnybear.library.util.log.Logger")) continue;
        ...
        BaseLogger.printDefault(D, tag, headString + msg);
    }
    ...
    private static void printLog(int type, String tagStr, Object... objects) {
        ...
        switch (type) {
            ...
            case JSON:
                ...
                break;
            case XML:
                XmlLogger.printXml(tag, msg, headString);
                break;
        }
    ...
    private static void printFile(String tagStr, File targetDirectory, String fileName, Object objectMsg) {
        ...
        FileLogger.printFile(tag, targetDirectory, fileName, headString, msg);
    }
    ...
    private static String[] wrapperContent(int stackTraceIndex, String tagStr, Object... objects) {
        ...
        if (mIsGlobalTagEmpty && TextUtils.isEmpty(tag))
            tag = TAG_DEFAULT;
        /*else if (TextUtils.isEmpty(tag) & !mIsGlobalTagEmpty)
            tag = mGlobalTag;*/
