...
import com.sunnybear.framework.ui.viewpager.banner.view.BannerViewPager;
...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    public Banner(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.imageLoader = new GlideBannerImageLoader();
    ...
    public Banner setImages(List<Image> images) {
