...
public class SweetAlertDialog extends Dialog implements View.OnClickListener {
    ...
    private boolean isDialogClick = true;
    ...
    public static final int HINT_TYPE = 6;

    public interface OnSweetClickListener {
        void onClick(SweetAlertDialog sweetAlertDialog);
    }

    public static SweetAlertDialog getDialog(Context context, int alertType) {
        return new SweetAlertDialog(context, alertType);
    }

    public static SweetAlertDialog getDialog(Context context) {
        return new SweetAlertDialog(context, NORMAL_TYPE);
    }
    ...
    private SweetAlertDialog(Context context, int alertType) {
        ...
        if (Build.VERSION.SDK_INT <= Build.VERSION_CODES.GINGERBREAD_MR1) {
            ...
            for (; idx < childAnims.size(); idx++) {
                if (childAnims.get(idx) instanceof AlphaAnimation) break;
            }
    ...
    public SweetAlertDialog setDialogClick(boolean isDialogClick) {
