...
import com.sunnybear.framework.ui.picker.listener.OnDismissListener;
import com.sunnybear.framework.ui.picker.utils.PickerViewAnimateUtil;
...
public class BasePickerView {
    ...
    public void show() {
        if (isDialog()) {
            ...
            if (PhoneUtil.checkDeviceHasNavigationBar(mPickerOptions.context))
                PhoneUtil.showNavigationBar(mPickerOptions.decorView, false);
        }
    }
    ...
    public void dismissImmediately() {
        ...
        if (PhoneUtil.checkDeviceHasNavigationBar(mPickerOptions.context))
            PhoneUtil.showNavigationBar(mPickerOptions.decorView, true);
    }
