...
public class NestedRadioGroup extends LinearLayout {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    if (event.getAction() == MotionEvent.ACTION_DOWN && !((RadioButton) child).isChecked()) {
                        ...
                        if (mOnCheckedChangeListener != null) {
                            mOnCheckedChangeListener.onCheckedChanged(NestedRadioGroup.this, child.getId());
                        }
                    }
                    return true;
                }
                    ...
                    button.setOnTouchListener(new OnTouchListener() {
                        ...
                        public boolean onTouch(View v, MotionEvent event) {
                            if (event.getAction() == MotionEvent.ACTION_DOWN && !button.isChecked()) {
                                ...
                                if (mOnCheckedChangeListener != null) {
                                    mOnCheckedChangeListener.onCheckedChanged(NestedRadioGroup.this, button.getId());
                                }
                            }
                            return true;
                        }
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == NestedRadioGroup.this && child instanceof RadioButton) {
                int id = child.getId();
