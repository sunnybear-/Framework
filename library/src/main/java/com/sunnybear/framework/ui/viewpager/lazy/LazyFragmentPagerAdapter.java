package com.sunnybear.framework.ui.viewpager.lazy;
...
public abstract class LazyFragmentPagerAdapter extends LazyPagerAdapter<Fragment> {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        if (fragment != null) {
            if (DEBUG)
                Logger.v(TAG, "Attaching item #" + itemId + ": f=" + fragment);
    ...
    public void destroyItem(ViewGroup container, int position, Object object) {
        ...
        if (DEBUG)
            Logger.v(TAG, "Detaching item #" + getItemId(position) + ": f=" + object + " v=" + ((Fragment) object).getView());
