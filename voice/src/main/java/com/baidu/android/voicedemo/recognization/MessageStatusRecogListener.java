...
public class MessageStatusRecogListener extends StatusRecogListener {
    ...
    public MessageStatusRecogListener(Handler handler, OnVoiceRecognitionCallback onVoiceRecognitionCallback) {
        this.handler = handler;
    ...
    public void onAsrFinalResult(String[] results, RecogResult recogResult) {
        ...
        if (mOnVoiceRecognitionCallback != null)
            mOnVoiceRecognitionCallback.onVoiceRecognitionSuccess(results[0]);
    }
    ...
    public void onAsrFinishError(int errorCode, int subErrorCode, String errorMessage, String descMessage,
        ...
        speechEndTime = 0;
        if (mOnVoiceRecognitionCallback != null)
            mOnVoiceRecognitionCallback.onVoiceRecognitionFail(errorCode, descMessage);
    }
